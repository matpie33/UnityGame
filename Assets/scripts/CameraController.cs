...
using UnityEngine;
    ...
    public class CameraController : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            _targetRotation = Quaternion.LookRotation(planarDirection) * Quaternion.Euler(_targetVerticalAngle, 0, 0);
        ...
        private void Update()
        {
            Debug.DrawLine(_followTransform.position, _followTransform.position + _followTransform.forward * 10, Color.green);
            ...
            RaycastHit[] _hits = Physics.SphereCastAll(_focusPosition, _checkRadius, _targetRotation * -Vector3.forward, _targetDistance, _obstructionLayers); //cast ray from player model, ray is a sphere, ray toward camera, sphere is moving "_targetDistance" towards destination

            Debug.DrawLine(_followTransform.position, _followTransform.position + _targetRotation * -Vector3.forward, Color.cyan);
